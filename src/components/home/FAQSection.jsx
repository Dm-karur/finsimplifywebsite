...
export default function FAQSection() {
  ...
  const faqs = [
    ...
    { 
      ...
      a: "Our investment philosophy is grounded in long-term, evidence-based strategies. We prioritize diversification, risk-adjusted returns, and minimizing fees and taxes rather than trying to time the market." 
    },
    { 
  ...
  return (
    <section className="bg-white pt-10 pb-4 lg:pt-16 lg:pb-8">
