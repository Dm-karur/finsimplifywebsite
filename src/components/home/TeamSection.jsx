export default function TeamSection({ title, customPadding = "pt-12 lg:pt-16 pb-12 lg:pb-16" }) {
  const team = [
    { name: 'CA. Mayank Umbarkar', role: 'MANAGING PARTNER', image: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=400&q=80' },
    { name: 'CA. Anshul Soni', role: 'PARTNER', image: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=400&q=80' },
    { name: 'CA. Priyanka Sethi', role: 'PARTNER', image: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=400&q=80' },
    { name: 'CA. Ajinkya Nandanwar', role: 'CHARTERED ACCOUNTANT', image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=400&q=80' },
    { name: 'CA. Ashish Nehra', role: 'CHARTERED ACCOUNTANT', image: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&w=400&q=80' },
    { name: 'CS. Vaibhav Netke', role: 'COMPANY SECRETARY', image: 'https://images.unsplash.com/photo-1556157382-97eda2d62296?auto=format&fit=crop&w=400&q=80' }
  ];
          ...
          {team.map((member, idx) => (
            ...
            >
              ...
              <div className="p-8 flex justify-between items-center bg-white group-hover:bg-secondary transition-colors duration-300 mt-auto">
                <div>
                  <h3 className="text-[20px] md:text-[22px] font-medium text-primary font-['Work_Sans',sans-serif] mb-1">{member.name}</h3>
