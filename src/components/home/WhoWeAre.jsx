        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
          ...
          <div className="flex-[1.3] animate-fade-in-up w-full">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-[3rem] leading-[1.15] text-primary font-['Work_Sans',sans-serif] font-medium mb-12 tracking-tight max-w-4xl">
              Your Finance Partner for the  <br className="hidden lg:block" />

              <span className="text-secondary">Next Stage of Growth.</span>
            </h2>
            ...
            <div className="flex gap-6 mb-10">
              {['01', '02', '03'].map((tab) => (
                <button
                  ...
                  className={`pb-2 text-sm transition-all border-b-[2px] ${activeTab === tab
